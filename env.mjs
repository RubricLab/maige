...
export const env = createEnv({
	...
	runtimeEnv: {
		...
		GITHUB_BOT_ACCESS_TOKEN: process.env.GITHUB_BOT_ACCESS_TOKEN,
		GITHUB_BOT_EMAIL: process.env.GITHUB_BOT_EMAIL,
	...
	server: {
		...
		GITHUB_BOT_ACCESS_TOKEN: z.string().min(1),
		GITHUB_BOT_EMAIL: z.string().email(),
		GITHUB_BOT_USERNAME: z.string().min(1),
