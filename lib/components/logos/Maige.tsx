export const Maige = ({
	...
	return (
		...
		>
			<title>Maige Logo</title>
			<path d="M100 400H200V500H100V400Z" fill="currentColor" />
			<path d="M300 400H400V500H300V400Z" fill="currentColor" />
			<path d="M200 200H300V300H200V200Z" fill="currentColor" />
			<path d="M100 200H200V300H100V200Z" fill="currentColor" />
			<path d="M400 0H500V100H400V0Z" fill="currentColor" />
			<path d="M0 0H100V100H0V0Z" fill="currentColor" />
			<path d="M200 0H300V100H200V0Z" fill="currentColor" />
			<path d="M300 100H400V200H300V100Z" fill="currentColor" />
			<path d="M0 100H100V200H0V100Z" fill="currentColor" />
			<path d="M400 300H500V400H400V300Z" fill="currentColor" />
			<path d="M400 400H500V500H400V400Z" fill="currentColor" />
			<path d="M0 400H100V500H0V400Z" fill="currentColor" />
