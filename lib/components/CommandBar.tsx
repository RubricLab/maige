			...
			<Button
				...
				<div className='flex h-10 flex-row justify-between'>
					...
					<kbd className='hidden items-center gap-1 px-[0.2rem] py-[0.2rem] font-mono sm:inline-flex'>
						<span className='flex h-[25px] w-[25px] items-center justify-center rounded bg-primary/20'>
							<CommandIcon width={12} />
						</span>{' '}
						<span className='flex h-[25px] w-[25px] items-center justify-center rounded bg-primary/20 text-sm'>
