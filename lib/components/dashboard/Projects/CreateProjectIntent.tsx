...
function AddButton() {
	...
	return (
		<Button
			type='submit'
			className='border-tertiary hover:border-secondary relative flex h-full min-h-36 w-full cursor-pointer items-center justify-center gap-2 rounded-sm border !border-dashed bg-transparent p-4 py-3.5 text-base transition-all'
			disabled={pending}>
			<PlusIcon />
			Add project
		</Button>
